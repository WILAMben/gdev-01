...
include('/static/static_files/twitter/jquery.tweet.js'); // Twitter widget
include('/static/static_files/js/tinynav.min.js'); // Tiny nav



/*

document.write('<script src="static/didaben/twitter/jquery.tweet.js" type="text/javascript"></script>')
document.write('<script src="static/didaben/js/tinynav.min.js" type="text/javascript"></script>')
*/
...
$(document).ready(function(){
	...
	productButtons.hover(function(){
		...
		var productButtons = $('.product-actions').not('.full-width');
	productButtons.find('>button:first-child').addClass('current');
	...
	productButtons.hover(function(){
		...
		$(this).find('>button:first-child').addClass('current');
	});
